...
const availableUsers = ref([
  { id: 1, name: 'Andrea Ramirez', email: 'andrea.ramirez@eventgo.com' },
  { id: 2, name: 'Carlos Mendoza', email: 'carlos.mendoza@eventgo.com' },
  { id: 3, name: 'María Torres', email: 'maria.torres@eventgo.com' },
  { id: 4, name: 'Juan Pérez', email: 'juan.perez@eventgo.com' },
  { id: 5, name: 'Laura García', email: 'laura.garcia@eventgo.com' },
  { id: 6, name: 'Roberto Silva', email: 'roberto.silva@eventgo.com' },
  { id: 7, name: 'Ana Martínez', email: 'ana.martinez@eventgo.com' }
]);
